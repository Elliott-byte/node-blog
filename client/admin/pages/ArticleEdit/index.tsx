...
export default function Index(props) {
    ...
    const publish = (data) => {
        ...
        if (!isLength(data?.content, { min: 1, max: 15000 })) {
            return message.error('Article content cannot be empty, and the length cannot exceed 15000 characters!');
        }
            ...
            >
                <div className={style.header}>
                    <div className={style.leftItem}>
                        ...
                        <div className={style.type}>{id ? 'Edit Article' : 'Add Article'}</div>
                    </div>
                    <div className={style.editorWrap}>
                        <Form.Item
                            ...
                            rules={[
                                {
                                    required: true,
                                    message: 'Title cannot be empty and must be at most 80 characters!',
                                    max: 80,
                                },
                            ]}
                        >
                            <TextArea placeholder="Enter title" rows={1} style={{ textAlign: 'center' }} />
                        </Form.Item>
                    </div>
                    ...
                    <div style={{ display: 'flex', width: '920px' }}>
                        <div className={style.drawerContent}>
                            <Form.Item
                                ...
                                label="Cover Image"
                                name="screenshot"
                                rules={[{ required: true, message: 'Cover image cannot be empty!' }]}
                            >
                            ...
                            >
                                <Select loading={categoryLoading} placeholder="Select a category">
                                    {categoryOptions}
                                </Select>
                            </Form.Item>
                            <Form.Item name="tags" label="Article Tags">
                                <EditableTagGroup />
                            </Form.Item>
                        </div>
