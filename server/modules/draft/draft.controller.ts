...
export class DraftController {
  ...
  @Roles('admin')
  public async create(
    @JoiBody(DraftJoiSchema, { method: 'post' }) draft: Draft,
  ) {
  ...
  public async update(
    ...
    @JoiBody(DraftJoiSchema) draft: Draft,
  ) {
  ...
  //todo delete draft and drafts
  //   @Delete('/articles/:id')
  //   @Roles('admin')
  //   public async deleteDraft(@JoiParam(ObjectIdSchema) )
}
